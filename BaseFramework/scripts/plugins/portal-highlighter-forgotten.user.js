...
// @updateURL      https://secure.jonatkins.com/iitc/release/plugins/portal-highlighter-forgotten.meta.js
// @downloadURL    https://secure.jonatkins.com/iitc/release/plugins/portal-highlighter-forgotten.user.js
// @description    [jonatkins-2015-09-17-154202] Use the portal fill color to denote if the portal is unclaimed with no recent activity. Shades of red from one week to one month, then tinted to purple for longer. May also highlight captured portals that are stuck and fail to decay every 24 hours.
