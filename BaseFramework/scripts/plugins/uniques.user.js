...
// @updateURL      https://secure.jonatkins.com/iitc/release/plugins/uniques.meta.js
// @downloadURL    https://secure.jonatkins.com/iitc/release/plugins/uniques.user.js
// @description    [jonatkins-2015-09-17-154202] Allow manual entry of portals visited/captured. Use the 'highlighter-uniques' plugin to show the uniques on the map, and 'sync' to share between multiple browsers or desktop/mobile. It will try and guess which portals you have captured from COMM/portal details, but this will not catch every case.
