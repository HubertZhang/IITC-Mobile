...
//            ScriptsManagerNew.updateFiles(scriptsPath).subscribeOn(SerialDispatchQueueScheduler.init(internalSerialQueueName: "com.cradle.IITC-Mobile.network")).observeOn(MainScheduler.sharedInstance).subscribe(onNext: { (result) -> Void in
//                    print("1")
//                    finished = finished + 1
